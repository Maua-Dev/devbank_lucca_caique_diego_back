...
class Test_Main:
    ...
    def test_deposit_transaction(self):
        body = {"2": 0, "5": 2, "10": 0, "20": 0, "50": 0, "100": 0, "200": 0}
    ...
    def test_deposit_transaction_value_to_higher(self):
        ...
        body = {"2": 0, "5": 0, "10": 0, "20": 0, "50": 0, "100": 0, "200": 13}
    ...
    def test_withdraw_transaction(self):
        ...
        body = {"2": 0, "5": 0, "10": 0, "20": 0, "50": 0, "100": 0, "200": 1}
    ...
    def test_get_history(self):
        ...
        for transaction_response, transaction_mock in zip(
            transactions_response, repo.transactions
        ):
            assert (
            ...
            assert (
                ...
                == transaction_mock.current_balance
            )
